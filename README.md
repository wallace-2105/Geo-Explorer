...
Utilize uma stack moderna e adequada para produção.
...
Se a plataforma utilizar outra estrutura internamente, mantenha o código organizado e facilmente integrável com um backend Node.js/TypeScript posteriormente.

Identidade visual

Quero uma interface moderna de plataforma de tecnologia/educação.
...
Evite aparência de projeto genérico gerado por IA.

Quero uma interface que pareça um produto real.
...
Desafios realizados: 18
Progresso atual: 72%

Criar cards visualmente interessantes.
...
botão para iniciar/continuar

Criar uma timeline ou estrutura visual para os módulos.
...
Depois visualizar o desafio.

A interface deve estar preparada para futuramente receber um desafio gerado pelo backend/IA.
